...
const ConfirmDialog = ({
    ...
    return (
        ...
        >
            <div
                className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-md border border-slate-200 dark:border-slate-700 animate-in zoom-in-95 duration-200"
            ...
            >
                <div className="p-6">
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 id="confirm-dialog-title" className="text-lg font-bold text-slate-900 dark:text-slate-100">
                                {title}
                            </h3>
                ...
                <div className="flex justify-end gap-2 px-6 py-4 bg-slate-50 dark:bg-slate-800/50 rounded-b-xl border-t border-slate-100 dark:border-slate-700/50">
