        ...
        <div className="fixed inset-0 top-0 left-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-xl w-full max-w-md p-6 relative animate-in zoom-in-95 duration-200">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Carregue uma planilha para adicionar contratos em lote.</p>
                </div>

                <div
                    className={`border-2 border-dashed rounded-lg p-8 flex flex-col items-center justify-center transition-colors cursor-pointer ${dragging ? 'border-teal-500 bg-teal-50' : 'border-slate-300 hover:border-teal-400 hover:bg-slate-50 dark:bg-slate-800/50'
                        }`}
                ...
                >
                    ...
                    {file ? (
                        ...
                        <div className="text-center pointer-events-none">
                            ...
                            <p className="text-sm font-medium text-slate-600 dark:text-slate-400">Arraste seu arquivo aqui</p>
