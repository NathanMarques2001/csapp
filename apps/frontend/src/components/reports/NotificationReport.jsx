            ...
            {showFilters && (
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 animate-in fade-in slide-in-from-top-2">
                    ...
                    <div>
                        ...
                        <select name="modulo" value={filters.modulo} onChange={handleFilterChange} className="w-full text-sm border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2 px-3">
                            <option value="">Todos</option>
                            {modulos.map((m) => (
                    ...
                    <div>
                        <label className="block text-xs font-medium text-slate-700 mb-1">Confirmado</label>
                        <select name="confirmado" value={filters.confirmado} onChange={handleFilterChange} className="w-full text-sm border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2 px-3">
                            <option value="">Todos</option>
                    ...
                    <div>
                        <label className="block text-xs font-medium text-slate-700 mb-1">Índice Reajuste</label>
                        <select name="indiceReajuste" value={filters.indiceReajuste} onChange={handleFilterChange} className="w-full text-sm border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2 px-3">
                            <option value="">Todos</option>
                    ...
                    <div>
                        <label className="block text-xs font-medium text-slate-700 mb-1">Renovação Automática</label>
                        <select name="renovacaoAutomatica" value={filters.renovacaoAutomatica} onChange={handleFilterChange} className="w-full text-sm border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2 px-3">
                            <option value="">Todos</option>
                            <option value="sim">Sim</option>
                            <option value="não">Não</option>
                        </select>
